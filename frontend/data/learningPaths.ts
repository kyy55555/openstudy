...
export const learningPaths: LearningPath[] = [
  {
    ...
    phases: [
      ...
      term("Year 4 · Fall", "大四上", "Continue approved track electives and complete independent inquiry.", "继续批准的方向选修，并完成独立研究要求。", ["mit-6-824", "mit-6-172", "mit-6-830", "stanford-cs229", "stanford-ee364a"], ["Independent-inquiry subject"], ["独立研究课程"], 2),
  ...
  },
  {
    ...
    phases: [
      ...
      term("Year 3 · Spring", "大三下", "Continue with Berkeley database systems and approved technical electives.", "继续 Berkeley 数据库系统及获批技术选修。", ["berkeley-cs186", "stanford-cs229", "mit-6-837", "mit-6-824"], [], [], 2),
      term("Year 4 · Fall", "大四上", "Choose advanced electives while satisfying official breadth rules.", "在满足官方广度规则的前提下选择高阶课程。", ["berkeley-cs162", "berkeley-cs170", "berkeley-cs186", "mit-6-858", "mit-6-824", "stanford-ee364a"], [], [], 2),
