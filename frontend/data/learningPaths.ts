...
export const learningPaths: LearningPath[] = [
  ...
  },
  {
    ...
    phases: [
      ...
      term("Year 2 · Spring", "大二下", "Begin the required theory foundation; BSE students also continue science and engineering foundations.", "开始必修理论基础；BSE 学生同时继续科学与工程基础。", ["princeton-cos240", "mit-5-111sc"], ["BSE engineering requirement"], ["BSE 工程课程要求"]),
  ...
  },
  {
    ...
    calendar: "semester",
    phases: [
      term("Year 1 · Fall", "大一上", "Begin programming, calculus, and laboratory science.", "开始编程、微积分与实验科学。", ["mit-6-100l", "mit-18-01sc", "mit-8-01sc"]),
      term("Year 1 · Spring", "大一下", "Continue programming, calculus, and science.", "继续编程、微积分与科学基础。", ["berkeley-cs61a", "mit-18-02sc", "mit-8-02"]),
      term("Year 2 · Fall", "大二上", "Build data-structure, discrete-mathematics, and linear-algebra foundations.", "建立数据结构、离散数学和线性代数基础。", ["berkeley-cs61b", "mit-6-042j", "mit-18-06"]),
      term("Year 2 · Spring", "大二下", "Add systems, algorithms, and probability before advanced work.", "在高阶课程前完成系统、算法与概率基础。", ["cornell-cs3410", "mit-6-006", "mit-18-05"]),
      term("Year 3 · Fall", "大三上", "Select core work in systems, logic/languages, or theory.", "在系统、逻辑与语言或理论中完成核心课程。", ["mit-6-s081", "princeton-cos240", "mit-6-046j"], [], [], 2),
  ...
  },
  {
    ...
    calendar: "semester",
    phases: [
      term("Year 1 · Fall", "大一上", "Follow the official first-year pattern with introductory programming and calculus.", "按官方大一结构学习编程入门与微积分。", ["mit-6-100l", "mit-18-01sc"]),
      term("Year 1 · Spring", "大一下", "Continue object-oriented programming/data structures and multivariable calculus.", "继续面向对象编程与数据结构，并学习多元微积分。", ["berkeley-cs61b", "mit-18-02sc"]),
      ...
      term("Year 3 · Spring", "大三下", "Choose approved technical electives across multiple CS areas.", "跨多个计算机领域选择获批技术选修。", ["berkeley-cs186", "stanford-cs144", "mit-6-858", "mit-6-837"], [], [], 2),
  ...
  },
  {
    ...
    phases: [
      ...
      term("Year 2 · Spring", "大二下", "Add probability, algorithms, and systems foundations.", "补充概率、算法与系统基础。", ["mit-18-05", "mit-6-006", "princeton-cos217"]),
  ...
  },
  {
    ...
    calendar: "semester",
    phases: [
      term("Year 1 · Fall", "大一上", "Begin programming, calculus, and laboratory science.", "开始编程、微积分与实验科学。", ["mit-6-100l", "mit-18-01sc", "mit-5-111sc"]),
      term("Year 1 · Spring", "大一下", "Continue programming, calculus, and science.", "继续编程、微积分与科学。", ["berkeley-cs61a", "mit-18-02sc", "mit-8-01sc"]),
      term("Year 2 · Fall", "大二上", "Build data structures, discrete structures, and linear algebra.", "建立数据结构、离散结构与线性代数基础。", ["berkeley-cs61b", "mit-6-042j", "mit-18-06"]),
  ...
  },
  {
    ...
    phases: [
      ...
      term("Year 2 · Fall", "大二上", "Build data structures, discrete mathematics, and computer organization.", "建立数据结构、离散数学与计算机组成基础。", ["berkeley-cs61b", "mit-6-042j", "cornell-cs3410"]),
      ...
      term("Year 3 · Fall", "大三上", "Start two selected Threads after the common foundations.", "完成共同基础后，开始两个自选 Threads。", ["berkeley-cs170", "berkeley-cs162", "stanford-cs221", "mit-6-837"], ["Choose courses required by both selected Threads"], ["选择两个 Threads 要求的课程"], 2),
  ...
  },
  {
    ...
    calendar: "semester",
    phases: [
      term("Year 1 · Fall", "大一上", "Begin calculus, programming, and science foundations.", "开始微积分、程序设计与科学基础。", ["mit-18-01sc", "mit-6-100l", "mit-8-01sc"]),
      ...
      term("Year 2 · Fall", "大二上", "Build discrete mathematics, data structures, and digital/computer organization.", "建立离散数学、数据结构与数字逻辑/计算机组成基础。", ["mit-6-042j", "berkeley-cs61b", "berkeley-cs61c"]),
      ...
      term("Year 3 · Fall", "大三上", "Complete core operating systems, networks, databases, and theory.", "完成操作系统、网络、数据库与理论核心。", ["berkeley-cs162", "stanford-cs144", "berkeley-cs186", "stanford-cs103"]),
      term("Year 3 · Spring", "大三下", "Choose advanced directions after the common core.", "完成共同核心后选择高阶方向。", ["stanford-cs221", "berkeley-cs189", "mit-6-837", "mit-6-858", "stanford-cs143"], [], [], 2),
  ...
  },
  {
    ...
    calendar: "semester",
    phases: [
      term("Year 1 · Fall", "大一上", "Begin programming and mathematical analysis/calculus.", "开始程序设计与数学分析/微积分。", ["mit-6-100l", "mit-18-01sc"]),
      term("Year 1 · Spring", "大一下", "Continue programming, calculus, and physics.", "继续程序设计、微积分与物理。", ["berkeley-cs61a", "mit-18-02sc", "mit-8-01sc"]),
      term("Year 2 · Fall", "大二上", "Build data structures, discrete mathematics, linear algebra, and computer organization.", "建立数据结构、离散数学、线性代数与计算机组成基础。", ["berkeley-cs61b", "mit-6-042j", "mit-18-06", "berkeley-cs61c"]),
      ...
      term("Year 3 · Fall", "大三上", "Complete operating systems, databases, networks, and theory foundations.", "完成操作系统、数据库、网络与理论基础。", ["berkeley-cs162", "berkeley-cs186", "stanford-cs144", "stanford-cs103"]),
