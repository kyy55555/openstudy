...
export const learningPaths: LearningPath[] = [
  ...
  },
  {
    ...
    officialRequirementNotes: ["The official four-year curriculum includes calculus, linear algebra, probability, physics, programming, discrete mathematics, data structures, digital logic, computer organization, operating systems, networks, databases, algorithms, theory, AI, software engineering, and practical or capstone work.", "Upper-level study contains substantial direction electives rather than one mandatory fixed sequence.", "The linked TsinghuaX linear-algebra course is a public self-study edition from Tsinghua faculty; it supports the same foundation but does not assert equivalence to a specific on-campus section.", "Linked courses from other universities are self-study substitutes and do not imply Tsinghua credit equivalence."],
    officialRequirementNotesZh: ["官方四年方案包括微积分、线性代数、概率、物理、程序设计、离散数学、数据结构、数字逻辑、计算机组成、操作系统、网络、数据库、算法、理论、人工智能、软件工程与实践或毕业设计。", "高年级包含较多方向选修，并非只有一条强制固定顺序。", "所链接的 TsinghuaX 线性代数由清华教师建设，是同校公开自学版本；它支持相同基础学习，但不声称等同于某个校内教学班。", "外校链接仅为自学替代资料，不代表清华学分等价。"],
    scheduleStatus: "prerequisite-inferred",
    calendar: "semester",
    phases: [
