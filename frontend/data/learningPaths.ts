...
export const learningPaths: LearningPath[] = [
  ...
  },
  {
    ...
    phases: [
      ...
      term("Year 3 · Fall", "大三上", "Choose theoretical CS, systems, and data-systems courses under the official breadth rules.", "按官方广度规则选择理论计算机、系统与数据系统课程。", ["harvard-cs1610", "harvard-cs1650", "mit-6-046j", "stanford-cs143"], [], [], 2),
