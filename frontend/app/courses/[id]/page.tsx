...
export default function CourseDetailPage() {
  ...
  const { library, loaded, syncIssue, retryCloudSync, setProgress, toggleFavorite, toggleResource, createStudyPlan, updateStudyPlanDays, togglePlanPaused, toggleStudyTask, removeStudyPlan, recordResourceOpen } = useCourseLibrary();
  ...
  const taskCompleted = (task: (typeof generatedTasks)[number]) => Boolean(
    savedPlan?.completedTaskIds.includes(task.id) ||
    (task.sourceTaskId && savedPlan?.completedTaskIds.includes(task.sourceTaskId)),
  );
