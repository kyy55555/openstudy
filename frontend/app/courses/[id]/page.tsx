...
export default function CourseDetailPage() {
  ...
  const suggestedDays = savedPlan ? suggestedGentlePlanDays(savedPlan.days, savedPlan.createdOn, completedPlanTasks, totalPlanTasks) : null;
