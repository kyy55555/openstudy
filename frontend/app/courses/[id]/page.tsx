...
export default function CourseDetailPage() {
  ...
  const { library, loaded, syncIssue, setProgress, toggleFavorite, toggleResource, createStudyPlan, toggleStudyTask, removeStudyPlan, recordResourceOpen } = useCourseLibrary();
