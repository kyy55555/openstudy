...
import { feedbackAppVersion, feedbackViewport, isFeedbackIssueType, legacyFeedbackMessage, shouldRetryLegacyFeedback, type FeedbackIssueType } from "../../data/feedback";
...
function FeedbackContent() {
  ...
  const [issueType, setIssueType] = useState<FeedbackIssueType>(courseId ? "broken-link" : "other");
