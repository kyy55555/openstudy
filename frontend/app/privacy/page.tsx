...
function PrivacyContent() {
  ...
  return <main className="mx-auto min-h-screen max-w-3xl px-6 py-12">
    ...
    <p className="mt-2 text-sm text-gray-500">{language === "zh" ? "Beta 版本 · 更新于 2026 年 8 月 22 日" : "Beta version · Updated August 22, 2026"}</p>
    <div className="mt-8 space-y-6 leading-7 text-gray-700">
      ...
      <section><h2 className="text-lg font-semibold text-black">{language === "zh" ? "分析与广告" : "Analytics and advertising"}</h2><p className="mt-2">{language === "zh" ? "当前 Beta 不使用广告追踪器，也没有接入第三方产品分析服务。托管和数据库服务仍可能为安全、可靠性和运行日志处理必要的技术信息。未来若增加产品分析，将先更新本说明，并优先采用最少数据方案。" : "The current Beta uses no advertising trackers and no third-party product analytics service. Hosting and database providers may still process technical information needed for security, reliability, and operational logs. If product analytics is added later, this notice will be updated first and data collection will be minimized."}</p></section>
